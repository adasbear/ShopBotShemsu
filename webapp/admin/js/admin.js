      ...
      return `<div class="bg-white border-4 border-ink-black hard-shadow p-4">
        <div class="flex justify-between items-center gap-2">
          ...
          <div class="flex gap-1 flex-shrink-0">
            ...
            <button class="${st?.locked ? 'bg-kelp-green' : 'bg-secondary-fixed'} text-ink-black px-2 py-1 border-2 border-ink-black font-label-mono text-label-mono text-xs hard-shadow active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all" onclick="toggleLock('${i.name}')">${st?.locked ? "Unlock" : "Lock"}</button>
